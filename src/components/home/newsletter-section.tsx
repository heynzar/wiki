  ...
  return (
    <section className="mx-auto max-w-4xl flex flex-col md:flex-row items-center gap-10 mt-12 mb-6 md:my-24 py-12 px-6">
      ...
      <div className="relative mt-10 md:mt-0 max-[300px]:hidden flex group items-center justify-center w-full md:w-auto shrink-0">
        <div className="w-60 h-80 absolute rotate-[10deg] group-hover:translate-x-4 bg-white dark:bg-neutral-50 border rounded shadow-lg group-hover:-translate-y-2 duration-500 ease-in-out transition-transform z-10">
          <LetterCard name={name} />
        </div>
        <div className="rounded group-hover:-translate-x-2 duration-500 ease-in-out transition-transform absolute bg-white dark:bg-neutral-50 border rotate-3 group-hover:-rotate-z-3 z-5 shadow-lg w-60 h-80" />
