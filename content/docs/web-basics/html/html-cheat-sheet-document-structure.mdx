...
<div className="img-dev">
  ...
  ](/visuals/wiki/web-basics/html/html-cheat-sheet-document-structure_html-basic-document-and-structure_why-the-web-split-into-3-languages.png)
</div>
...
**What did pages look like before this line existed?**
Back before `<!DOCTYPE html>` was standardized, developers had to write long, ugly declarations like this just to get modern rendering:
...
<div className="img-dev">
  ...
  ](/visuals/wiki/web-basics/html/html-cheat-sheet-document-structure_html-basic-document-and-structure.png)
</div>
