...
# Part 1: How Computing Works

<div className="img-dev">
  ![How Computing Works
  Cover](/visuals/wiki/foundation/how-computing-works/cover.png)
</div>
...
<Container cols={2}>
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-a-computer-works-cpu-ram-storage-io"
    title="How a Computer Works"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-operating-systems-work-processes-threads-memory"
    title="How Operating Systems Work"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-file-systems-work"
    title="How File Systems Work"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-networking-works-ip-dns-tcp-udp-http"
    title="How Networking Works"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-the-internet-works-routers-packets-protocols"
    title="How the Internet Works"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-browsers-work-parsing-rendering-dom"
    title="How Browsers Work"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-web-applications-work-client-server-model"
    title="How Web Applications Work"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/how-servers-work-what-happens-when-you-hit-a-url"
    title="How Servers Work"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/binary-hexadecimal-and-how-computers-store-data"
    title="How Computers Store Data (Binary)"
  />
  <NavigationButton
    file
    href="/docs/foundation/how-computing-works/the-abstraction-ladder-hardware-os-runtime-app"
