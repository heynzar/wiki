...
A modern CPU has multiple **cores**, which are like independent mini-brains inside the same chip. Each core can work on a different task at the same time. That's why your computer can play music, run your code editor, and keep fifty browser tabs open all at once, different cores are quietly splitting the work.
